...
Sampath Bank 07-NOV`,
			want: &finance.SampathModel{
				...
				Status:                   "authorized",
				AvailableBalance:         40289.06,
				AvailableBalanceCurrency: "LKR",
			},
		},
		{
